...
const SCORING_CONFIG = {
  ...
  manualTests: {
    valgusStress: { // 外反ストレステスト
      negative: { pes: 1, pfps: 0, plica: 0, hoffa: 0, meniscus: 0, saphenous: 0, description: 'MCLの目立つ所見なし' },
  ...
  imaging: {
    xray: {
      ...
      patellarMalalignment: { // 膝蓋骨アライメントの特徴
        pes: 0, pfps: 3, plica: 1, hoffa: 1, meniscus: 0, saphenous: 0,
        description: '膝蓋骨アライメントの特徴が関連'
      }
    },
    ultrasound: {
  ...
  recommendations: {
    pes: {
      high: [
        '鵞足部圧痛の再確認と局在の整理',
        'MCL・内側半月板まわりの所見を確認',
        '画像所見がある場合は鵞足滑液包周辺の情報を確認',
        '荷重・歩容の観察（過度な外反モーメント）'
      ],
      moderate: [
        '鵞足部の触診所見を整理',
        '膝内側構造（MCL、内側半月板）まわりの所見を確認',
        '姿勢・歩容の観察'
      ]
    },
    pfps: {
    ...
    plica: {
      high: [
        'MPPテストの再確認',
        '棚周辺の触知・可動性の確認',
        '画像所見がある場合は棚肥厚周辺の情報を確認',
        '気になる状態が続く場合は専門家と一緒に確認'
      ],
      moderate: [
        '膝前内側の詳細な触診',
        '引っかかり感の再現性を確認',
    ...
    meniscus: {
      high: [
        ...
        '関節裂隙周辺の圧痛を確認',
        '画像所見がある場合は半月板周辺の情報を確認',
        '気になる状態やロッキング感が続く場合は専門家と一緒に確認'
      ],
      moderate: [
        '半月板テストの所見を整理',
        'ACL・MCLまわりの所見を確認',
